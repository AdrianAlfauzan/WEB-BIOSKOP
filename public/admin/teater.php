...
<html lang="en">
  ...
  <body class="bg-blue-950 flex">
    ...
    <div class="Admin xl:ms-[300px]">
      ...
      <a href='../pages/teater/createteater.php'>
        <button
      ...
      >
        <thead>
          <tr class="">
            <th
              class="border-2 border-slate-950 p-2 w-[100px] text-[10px] xl:text-base xl:w-[415px]"
            >
              NAMA TEATER
            </th>
            <th
              class="border-2 border-slate-950 p-2 w-[] text-[10px] xl:text-base xl:w-[415px]"
            >
              NO KURSI
            </th>
            <th
        ...
        ?>
              ...
              <?php
                  ...
                  $result = mysqli_query($koneksi, "SELECT * FROM teater");
                  while ($row = mysqli_fetch_assoc($result)) {
                      echo "<tr>
                              <td class='border-2 border-slate-950 p-2 w-80'>{$row['nama_teater']}</td>
                              <td class='border-2 border-slate-950 p-2 w-80'>{$row['no_kursi']}</td>
                              <td class='border-2 border-slate-950 p-2'>
                                  <div class='flex justify-center mt-4'>
                                  <a href='../pages/teater/updateteater.php?id=" . $row['nama_teater'] . "'>
                              ...
                              <a href='?nama_teater={$row['nama_teater']}' onclick='return confirm(\"Apakah Anda yakin ingin menghapus?\")'>
